"""
SRM Data Collection — Imran Khan 2018
Colectează: V (viral velocity), lambda (decay), N (network), A (affective)
Surse: Google Trends, Wikipedia Pageviews, GDELT
"""
...
def main():
    ...
    params = {
        ...
        "srm_formula": "SRM = V × A × exp(-lambda × D) × N",
        "errors": errors
    }
